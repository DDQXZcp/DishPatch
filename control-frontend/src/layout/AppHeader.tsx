    ...
    <header className="sticky top-0 z-[99999] w-full border-b border-brand-border bg-white shadow-sm">
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between lg:px-6">
        ...
        <div className="flex w-full items-center justify-between gap-3 px-3 py-3 lg:w-auto lg:px-0 lg:py-4">
          <div className="flex items-center gap-3">
            <button
              ...
              className="z-[99999] flex h-10 w-10 items-center justify-center rounded-xl border border-brand-border bg-white text-slate-600 transition-all duration-200 hover:border-brand hover:bg-brand-light hover:text-brand focus:outline-none focus:ring-2 focus:ring-brand/20 lg:h-11 lg:w-11"
            >
              {isMobileOpen ? (
                <svg
                  width="22"
            ...
            <Link
              to="/"
              className="flex items-center rounded-lg transition-opacity hover:opacity-80 lg:hidden"
        ...
        <div className="hidden flex-1 items-center justify-center lg:flex">
          <h1 className="text-lg font-semibold tracking-[0.02em] text-slate-800 xl:text-xl">
            DishPatch{" "}
