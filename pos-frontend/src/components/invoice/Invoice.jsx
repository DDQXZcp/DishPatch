    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
      <div className="bg-white p-4 rounded-lg shadow-lg w-[400px]">
        ...
        <div ref={invoiceRef} className="p-4">
          ...
          <h2 className="text-xl font-bold text-center mb-2">Payment Success</h2>
            ...
            <ul className="text-sm text-gray-700">
              {orderInfo.items.map((item, index) => (
                ...
                >
                  ...
                  <span>{AUDFormatter.format(item.price)}</span>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div className="mt-4 border-t pt-4 text-sm">
            <p>
              <strong>Subtotal:</strong> {AUDFormatter.format(orderInfo.bills.total)}
            </p>
            <p>
              <strong>GST (10%):</strong> {AUDFormatter.format(orderInfo.bills.tax)}
            </p>
            <p className="text-md font-semibold">
              <strong>Total (incl. GST)</strong> {AUDFormatter.format(orderInfo.bills.totalWithTax)}
            </p>
          </div>
