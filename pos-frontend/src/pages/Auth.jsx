    ...
    <div className="flex min-h-screen w-full">
      ...
      <div className="w-1/2 relative flex items-center justify-center bg-cover">
        ...
        <blockquote className="absolute bottom-10 px-8 mb-10 text-2xl italic text-white">
          ...
          <br />
          <span className="block mt-4 text-yellow-400">- HARBS Japan</span>
        </blockquote>
      </div>
      ...
      <div className="w-1/2 min-h-screen bg-[#1a1a1a] p-10">
        <div className="flex flex-col items-center gap-2">
          <img src={logo} alt="Restro Logo" className="h-18 w-18 p-1" />
          <h1 className="text-lg font-semibold text-[#f5f5f5] tracking-wide">Restaurant POS by Herman Tang</h1>
        </div>
